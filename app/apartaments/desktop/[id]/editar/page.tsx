    ...
    const fetchApartamento = async () => {
      ...
      try {
        const { data } = await api.get(
          `/Apartamento/BuscarApartamentoPorId/${id}`
        );
        setBloco(data.bloco || "");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const apiMessage =
        ...
        "Erro ao conectar com a API: verifique a URL ou o servidor.";
          ...
          <DeletePopup
            ...
            onConfirm={async () => {
              try {
                ...
                let msg = "Erro ao conectar com a API.";
            ...
            onConfirm={async () => {
              try {
                ...
                if (err.message == "Request failed with status code 400") {
                  setApiError(
                    "Este bloco e número já estão associados a outro apartamento."
                  );
                  setMostrarPopupSalvar(false);
                } else {
        ...
        >
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
            <div className="flex flex-col w-full sm:w-1/2">
              <label htmlFor="bloco" className="mb-2 font-medium text-gray-700">
                Bloco
              </label>
              <Input
                id="bloco"
